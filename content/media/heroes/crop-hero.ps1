...
$crops = @(
    ...
    @{ Start = '0.0';  End = '5.0';   Name = 'MT01_preview-intro' },
    @{ Start = '8.0';  End = '20.0';  Name = 'MT02_match-start'   },
    @{ Start = '30.0'; End = '150.0'; Name = 'MT03_ambient-loop'  },
    @{ Start = '0.0';  End = '60.0';  Name = 'MT04_main-theme'    }
)
...
# 5-second preview over the real master" failure mode early.
