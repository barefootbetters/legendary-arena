...
export const KEYWORD_GLOSSARY: Map<string, string> = new Map([
  ...
  ["ultimateabomination", "This Mastermind gets +Attack equal to the printed Attack of all Heroes in the HQ."],
  ["doublestriker", "\u201cDouble Striker\u201d means \u201cThis gets +2 Attack for each Master Strike in the KO pile and/or stacked next to the Mastermind.\u201d"],
  ["doubleabomination", "\u201cDouble Abomination\u201d means \u201cThis gets +2 Attack for each Abomination card in the KO pile.\u201d"],
  ["highestabomination", "\u201cHighest Abomination\u201d means \u201cThis gets +Attack equal to the highest printed Attack among Abomination cards in the KO pile.\u201d"],
  ["doubleempowered", "\u201cDouble Empowered\u201d means \u201cYou get +2 Attack for each card of the specified class in the HQ.\u201d"],
  ["triplestriker", "\u201cTriple Striker\u201d means \u201cThis gets +3 Attack for each Master Strike in the KO pile and/or stacked next to the Mastermind.\u201d"],
  ["tripleempowered", "\u201cTriple Empowered\u201d means \u201cYou get +3 Attack for each card of the specified class in the HQ.\u201d"],
  ["quadrupleempowered", "\u201cQuadruple Empowered\u201d means \u201cYou get +4 Attack for each card of the specified class in the HQ.\u201d"],
  ["doubledarkmemories", "\u201cDouble Dark Memories\u201d means \u201cThis gets +2 Attack for each Hero Class among cards in your discard pile.\u201d"],
  ["doublelaststand", "\u201cDouble Last Stand\u201d means \u201cThis gets +2 Attack for each empty space in the city.\u201d"],
  ["doubleshieldclearance", "You must discard two S.H.I.E.L.D. Heroes (or the same one twice) as an additional cost to fight this Villain."],
