...
const COACH_SYSTEM_PROMPT = [
  ...
  'Scheme Twists and Master Strikes come from the Villain Deck shuffle, not from the',
  'heroes: never blame the hero selection or purchases for how many there were. If',
  'the summary has no `adversityExpected`, there is nothing to compare against, so',
  'make no luck read at all.',
  ...
  'cleared the villains, so the human could focus on rescues).',
  '',
