...
function sampleUiState(): UIState {
  return {
    game: { phase: 'play', turn: 3, activePlayerId: 'alice', currentStage: 'main', hasActedThisTurn: false, hasHealedThisTurn: false, villainRevealedThisTurn: false, lastPlayEffectsFired: 0 },
    players: [],
