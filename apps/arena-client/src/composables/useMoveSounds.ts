 ...
 * useMoveSounds.ts
 *
 * The Surface-2 player-action-move cue (WP-419). It returns a `playMoveSound`
 ...
 *
 * @see WP-419 §B "Move-cue consumer"
 ...
 * @see DECISIONS.md D-24239 (dispatch-keyed Surface-2 cue, WP-412-engine-reusing)
 */
