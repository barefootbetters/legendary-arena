 ...
 * WP-421 **Surface 2** tactile-feedback layer. Unlike Surface 1
 ...
 * carries URLs only.
 *
 * @see WP-421 §A "Move-SFX manifest"
 * @see apps/arena-client/src/audio/sfxManifest.ts (the Surface-1 sibling)
 * @see DECISIONS.md D-24241 (Surface-2 action-move tactile SFX; dispatch-keyed)
 */
 ...
 * as an unfired-clip gap for a later UI-affordance WP — see WP-421 Out of Scope.
 */
