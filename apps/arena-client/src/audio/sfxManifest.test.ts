...
// why: the seven NotableGameEventType discriminators, spelled out locally so this
...
// half of the pin (an eighth engine variant breaks vue-tsc there); this is the
// runtime half. `bystanderRevealed` added by WP-602.
...
describe('sfxManifest (WP-412 §C) — exhaustive over NotableGameEventType', () => {
  test('maps exactly the seven notable-event keys', () => {
    assert.deepEqual(
