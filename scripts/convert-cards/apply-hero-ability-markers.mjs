...
// why: WP-743 / D-24566 — [keyword:master-strike-this-turn] (Grief) and
// [keyword:master-strike-or-ambush-this-turn] (Spring the Trap) are single-segment,
// no-magnitude condition markers; the engine turns each into a whole-turn wait-and-see gate
// on the line's printed +N[icon:…] grant.
