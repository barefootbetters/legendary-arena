...
export const HERO_COUNT_SOURCES: readonly HeroCountSource[] = [
  ...
  'distinct-hero-classes-played-this-turn', // why: WP-680 / D-24497, semantics corrected D-24529 — distinct hero colors among Heroes you HAVE (hand + play), self-inclusive, order-independent (countDistinctHeroClassesYouHave)
