...
describe('LegendaryGame', () => {
  ...
  it('defines moves: advanceStage, dodgeCard, drawCards, endMatchEarly, endTurn, fightMastermind, fightVillain, healWounds, playCard, recruitHero, recruitOfficer, resolveCopyPowersChoice, resolveCountScaledChoice, resolveDefeatChoice, resolveDiscardChoice, resolveDiscardToPlay, resolveDrawOrEmpowered, resolveGiveHqHeroChoice, resolveHeroChoice, resolveKoHeroChoice, resolveMelterKoChoice, resolveOptionalKoReward, resolveOptionalPutBottomHQ, resolvePlayVillainTopChoice, resolvePutAnyNumberBottomHQ, resolvePutCardsOnDeckChoice, resolveReorderChoice, resolveReturnOnDiscard, resolveReturnZeroCostDiscard, resolveScryKoChoice, resolveSeatChoice, resolveSmashDiscard, resolveUndercoverChoice, resolveVictoryPileCardPick, and revealVillainCard', () => {
    ...
    assert.deepStrictEqual(
      ...
      ['advanceStage', 'dodgeCard', 'drawCards', 'endMatchEarly', 'endTurn', 'fightMastermind', 'fightVillain', 'healWounds', 'playCard', 'recruitHero', 'recruitOfficer', 'resolveCopyPowersChoice', 'resolveCountScaledChoice', 'resolveDefeatChoice', 'resolveDiscardChoice', 'resolveDiscardToPlay', 'resolveDrawOrEmpowered', 'resolveGiveHqHeroChoice', 'resolveHeroChoice', 'resolveKoHeroChoice', 'resolveMelterKoChoice', 'resolveOptionalKoReward', 'resolveOptionalPutBottomHQ', 'resolvePlayVillainTopChoice', 'resolvePutAnyNumberBottomHQ', 'resolvePutCardsOnDeckChoice', 'resolveReorderChoice', 'resolveReturnOnDiscard', 'resolveReturnZeroCostDiscard', 'resolveScryKoChoice', 'resolveSeatChoice', 'resolveSmashDiscard', 'resolveUndercoverChoice', 'resolveVictoryPileCardPick', 'revealVillainCard'],
      'LegendaryGame must define exactly 36 moves',
    );
  });
