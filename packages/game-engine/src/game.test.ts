...
describe('LegendaryGame', () => {
  ...
  it('defines moves: advanceStage, dodgeCard, drawCards, endMatchEarly, endTurn, fightMastermind, fightVillain, healWounds, playCard, recruitHero, recruitOfficer, resolveCopyPowersChoice, resolveCountScaledChoice, resolveDefeatChoice, resolveDiscardChoice, resolveDiscardToPlay, resolveDoOver, resolveDrawOrEmpowered, resolveElectromagneticBubbleChoice, resolveGiveHqHeroChoice, resolveHeroChoice, resolveKoDiscardChoice, resolveKoHeroChoice, resolveMelterKoChoice, resolveOptionalKoReward, resolveOptionalPutBottomHQ, resolvePlayVillainTopChoice, resolvePutAnyNumberBottomHQ, resolvePutCardsOnDeckChoice, resolveReorderChoice, resolveReturnOnDiscard, resolveReturnZeroCostDiscard, resolveRuthlessDictatorChoice, resolveScryKoChoice, resolveSeatChoice, resolveSmashDiscard, resolveUndercoverChoice, resolveVictoryPileCardPick, and revealVillainCard', () => {
    ...
    assert.deepStrictEqual(
      ...
      ['advanceStage', 'dodgeCard', 'drawCards', 'endMatchEarly', 'endTurn', 'fightMastermind', 'fightVillain', 'healWounds', 'playCard', 'recruitHero', 'recruitOfficer', 'resolveCopyPowersChoice', 'resolveCountScaledChoice', 'resolveDefeatChoice', 'resolveDiscardChoice', 'resolveDiscardToPlay', 'resolveDoOver', 'resolveDrawOrEmpowered', 'resolveElectromagneticBubbleChoice', 'resolveGiveHqHeroChoice', 'resolveHeroChoice', 'resolveKoDiscardChoice', 'resolveKoHeroChoice', 'resolveMelterKoChoice', 'resolveOptionalKoReward', 'resolveOptionalPutBottomHQ', 'resolvePlayVillainTopChoice', 'resolvePutAnyNumberBottomHQ', 'resolvePutCardsOnDeckChoice', 'resolveReorderChoice', 'resolveReturnOnDiscard', 'resolveReturnZeroCostDiscard', 'resolveRuthlessDictatorChoice', 'resolveScryKoChoice', 'resolveSeatChoice', 'resolveSmashDiscard', 'resolveUndercoverChoice', 'resolveVictoryPileCardPick', 'revealVillainCard'],
