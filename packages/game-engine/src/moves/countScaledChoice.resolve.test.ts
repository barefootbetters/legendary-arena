...
function makeState(): LegendaryGameState {
  ...
  return {
    ...
    cardStats: {
      'recruiter-a#0': { attack: 0, recruit: 2, cost: 3, fightCost: 0, fightCostMode: 'static', fightCostBase: 0, hasAttackIcon: false, hasRecruitIcon: true },
      'recruiter-b#0': { attack: 0, recruit: 1, cost: 2, fightCost: 0, fightCostMode: 'static', fightCostBase: 0, hasAttackIcon: false, hasRecruitIcon: true },
      'attacker-a#0': { attack: 3, recruit: 0, cost: 4, fightCost: 0, fightCostMode: 'static', fightCostBase: 0, hasAttackIcon: true, hasRecruitIcon: false },
      'symbiotic-adaptation#0': { attack: 0, recruit: 0, cost: 6, fightCost: 0, fightCostMode: 'static', fightCostBase: 0, hasAttackIcon: true, hasRecruitIcon: true },
    },
