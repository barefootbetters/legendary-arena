...
// Regenerate with `pnpm gauntlet:configs`; verify with
// `pnpm gauntlet:configs:check` (WP-483 / EC-518 / D-24283).
//
// The per-scheme gauntlet approved-loadout config, baked from
// data/gauntlet-configs.json so packages/registry/src/gauntletConfigs.ts
// can validate it at load WITHOUT node:fs (browser-safe via the
// ./gauntletConfigs subpath). data/gauntlet-configs.json is the source of
// truth; the in-test freshness assertion in gauntletConfigs.test.ts (and
// `pnpm gauntlet:configs:check`) guard against drift.

export const GAUNTLET_CONFIGS_DATA: unknown = {
  "schemaVersion": 1,
  ...
  "slicing": {
    ...
    "henchmanGroupCountByPlayerCount": {
      "1": 1,
      "2": 1,
      "3": 1,
      "4": 2,
        ...
        "core": {
          ...
          "masterminds": {
            ...
            "magneto": {
              ...
              "anchorVillainGroup": "core/brotherhood",
              "baseVillainPool": [
                "core/brotherhood",
                "core/enemies-of-asgard",
                "core/hydra",
              ...
              "schemes": {
                "midtown-bank-robbery": {
                  ...
                  "variety": "Spider-Foes replace Enemies of Asgard"
                },
                "secret-invasion-of-the-skrull-shapeshifters": {
                  "schemeName": "Secret Invasion of the Skrull Shapeshifters",
                  "villainPool": [
                ...
                "portals-to-the-dark-dimension": {
                  ...
                  "variety": "Sentinel replace Doombot Legion"
                },
                "replace-earths-leaders-with-killbots": {
                  "schemeName": "Replace Earth's Leaders with Killbots",
                  "villainPool": [
            ...
            "red-skull": {
              ...
              "schemes": {
                "midtown-bank-robbery": {
                  ...
                  "variety": "Masters of Evil promoted ahead of Brotherhood"
                },
                "secret-invasion-of-the-skrull-shapeshifters": {
                  "schemeName": "Secret Invasion of the Skrull Shapeshifters",
                  "villainPool": [
                ...
                "portals-to-the-dark-dimension": {
                  ...
                  "variety": "Hand Ninjas lead ahead of Doombot Legion"
                },
                "replace-earths-leaders-with-killbots": {
                  "schemeName": "Replace Earth's Leaders with Killbots",
                  "villainPool": [
            ...
            "loki": {
              "mastermindName": "Loki",
              "anchorVillainGroup": "core/enemies-of-asgard",
              "baseVillainPool": [
                "core/enemies-of-asgard",
                "core/brotherhood",
                "core/hydra",
              ...
              "schemes": {
                ...
                "secret-invasion-of-the-skrull-shapeshifters": {
                  ...
                  "variety": "Radiation replace Enemies of Asgard"
                },
                "legacy-virus-the": {
                  "schemeName": "Legacy Virus, The",
                  "villainPool": [
