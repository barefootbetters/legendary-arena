...
- [ ] WP-083 — Fetch-Time Schema Validation for Registry-Viewer Clients — pending (2026-04-21 pre-flight v2 READY TO EXECUTE after PS-1/2/3 resolution + A-083-04 amendment; copilot-check v2 CONFIRM; awaiting session execution in fresh session)
