...
- [ ] WP-082 — Keyword & Rule Glossary Schema, Labels, and Rulebook Deep-Links ✅ Reviewed (2026-04-21 pre-flight READY TO EXECUTE with copilot-check 30/30 PASS after HOLD → CONFIRM cycle resolving PS-1..PS-4 + RISK FIX #1..#4; SPEC pre-flight bundle A0 lands session-context-wp082 + WORK_INDEX row + EC_INDEX row + EC-107 checklist + pre-flight + session prompt before execution)
...
- [ ] WP-084 — Delete Unused Auxiliary Metadata Schemas and Files — pending
  Dependencies: None. Independent of WP-082 and WP-083 (may execute
  first, last, or sandwiched between them).
  Execution Checklist: `docs/ai/execution-checklists/EC-109-delete-unused-auxiliary-metadata.checklist.md` (Draft)
