...
- `packages/registry/src/schema.schemeDeckCounts.test.ts` — **new** — twist-only key-absent, zero bystander, outlier-set application, no-over-encoding, 40-file validation.
