# EC-454 — Arena-Client Surface-2 Player-Action Move SFX (Execution Checklist)

**Source:** docs/ai/work-packets/WP-419-arena-client-surface2-move-sfx.md
...
- `App.vue` — WP-419 Surface-2: fire the local tactile cue at the dispatch chokepoint, before relaying, independent of the authoritative result.
...
- [ ] `docs/05-ROADMAP-MINDMAP.md` — WP-419 node glyph `📝 → ✅`; `pnpm roadmap:counts:write`; `pnpm roadmap:counts:check` exits 0.
