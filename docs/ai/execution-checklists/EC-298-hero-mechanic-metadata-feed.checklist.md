# EC-298 — Hero Mechanic Metadata Feed (Execution Checklist)

**Source:** docs/ai/work-packets/WP-267-hero-mechanic-metadata-feed.md
...
- Do NOT touch any `apps/registry-viewer` or `apps/dashboard` file (that is WP-268)
- `scope` is the literal `"hero"` — do not emit other scopes (WP-269)
...
- `docs/ai/DECISIONS.md` — **modified** — D-24044
...
- [ ] STATUS/WORK_INDEX/EC_INDEX flipped; D-24044 landed
- [ ] Commit prefix: `EC-298:` (code) + `SPEC:` (governance)
