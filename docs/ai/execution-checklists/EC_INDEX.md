...
**Last updated:** 2026-04-19 (EC-072 executed at commit `dd0e2fd` — WP-080 replay harness step-level API; `applyReplayStep` exported; `replayGame` loop delegates to it; MOVE_MAP remains single source of truth for dispatch per D-6304; WP-063 / EC-071 now unblocked at Pre-Session Gate #4)