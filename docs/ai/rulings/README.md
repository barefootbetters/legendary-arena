...
|---|---|---|
| `fire-villain-effect` | `executeVillainAbilities` with a single injected hook | reveal-or-wound, ko-wounds-current-hand-and-discard, the Melter ko-cullable park, capture-hq-hero, hero-deck-top-to-escape, capture-bystander, give-hq-hero-by-trait-to-current, give-hq-hero-each-player, swap-two-city-villains, ko-heroes-current-count-by-trait |
