...
| Friends & Ranked Trust (2026-07) | 16/18 | 2 open |
| Next Horizons | 0/2 | 2 📦 queued |
| Phase 10 — Debugging, Testing & Troubleshooting | 0/8 | 8 📝 placeholders |
| Governance Drafts | 2/3 | 1 ⏸ |
| **Total** | **364/369 WP ✅** (+ 4/4 Foundation Prompts) | 1 ⏸, 4 open |

**Open / blocked WPs (derived from WORK_INDEX, 5):** WP-042.1 ⏸ blocked; WP-349 open; WP-345 open; WP-376 open; WP-377 open.
<!-- ROADMAP-COUNTS:END -->
