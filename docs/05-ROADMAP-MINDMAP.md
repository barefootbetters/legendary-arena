...
| Hero Ability Coverage & Markup Pipeline | 30/31 | 1 open |
...
| **Total** | **268/270 WP ✅** (+ 4/4 Foundation Prompts) | 1 ⏸, 1 open |

**Open / blocked WPs (derived from WORK_INDEX, 2):** WP-042.1 ⏸ blocked; WP-273 open.
<!-- ROADMAP-COUNTS:END -->
