...
| Hero Ability Coverage & Markup Pipeline | 31/32 | 1 open |
...
| **Total** | **269/271 WP ✅** (+ 4/4 Foundation Prompts) | 1 ⏸, 1 open |

**Open / blocked WPs (derived from WORK_INDEX, 2):** WP-042.1 ⏸ blocked; WP-274 open.
<!-- ROADMAP-COUNTS:END -->
