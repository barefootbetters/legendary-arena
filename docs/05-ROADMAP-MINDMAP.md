...
| Hero Ability Coverage & Markup Pipeline | 51/52 | 1 open |
...
| **Total** | **372/375 WP ✅** (+ 4/4 Foundation Prompts) | 1 ⏸, 2 open |

**Open / blocked WPs (derived from WORK_INDEX, 3):** WP-042.1 ⏸ blocked; WP-349 open; WP-383 open.
<!-- ROADMAP-COUNTS:END -->
