  ...
  root((Legendary Arena))
    ["Multiplayer Deck-Builder\nboardgame.io + TypeScript + R2"]
      ...
      Gauntlet Leaderboards (Legends) (2026-07)
        ...
        ["WP-384 📝 Fixed-hero-pool gauntlet division (server) — migration 034 team_key column + artifact backfill (D-24187 carve-out) + pool-constrained standings (heroCount + 2 budget) + lazy -fixed board emission; drafted 2026-07-16; D-24187 server half"]
        ["WP-385 📝 Fixed-hero-pool gauntlet division (legends-board client) — Open | Fixed-Pool division toggle, hero-pool display on fixed entries, fixed claim chips; ⛔ BLOCKED on WP-384; drafted 2026-07-16; D-24187 client half"]
...
| Gauntlet Leaderboards (Legends) (2026-07) | 4/6 | 2 open |
| Friends & Ranked Trust (2026-07) | 18/18 | — |
| Next Horizons | 0/2 | 2 📦 queued |
| Phase 10 — Debugging, Testing & Troubleshooting | 0/8 | 8 📝 placeholders |
| Governance Drafts | 2/3 | 1 ⏸ |
| **Total** | **373/377 WP ✅** (+ 4/4 Foundation Prompts) | 1 ⏸, 3 open |

**Open / blocked WPs (derived from WORK_INDEX, 4):** WP-042.1 ⏸ blocked; WP-349 open; WP-384 open; WP-385 open.
<!-- ROADMAP-COUNTS:END -->
