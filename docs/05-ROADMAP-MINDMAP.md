...
| Hero Ability Coverage & Markup Pipeline | 30/32 | 2 open |
...
| **Total** | **268/271 WP ✅** (+ 4/4 Foundation Prompts) | 1 ⏸, 2 open |

**Open / blocked WPs (derived from WORK_INDEX, 3):** WP-042.1 ⏸ blocked; WP-273 open; WP-274 open.
<!-- ROADMAP-COUNTS:END -->
