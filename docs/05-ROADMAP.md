...
| 040-041 | Growth Governance through Architecture Audit | Simulation + Ops    | Change budget categories (WP-040 consumes `LIVE_OPS_FRAMEWORK.md` §8), architecture audit (WP-041) | ⬜ Pending |
