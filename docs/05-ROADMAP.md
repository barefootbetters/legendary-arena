...
| 052     | Player Identity, Replay Ownership & Access Control | Server / Identity + Storage | `PlayerId` branded type, `PlayerAccount`, `findReplayOwnership`, `legendary.replay_ownership` | ⬜ Ready for Implementation (v1.2 contract tightening 2026-04-24) |
| 053     | Competitive Score Submission & Verification | Server / Competition | `submitCompetitiveScore(PlayerIdentity, replayHash)`, idempotent retries, PAR drift guard | ⬜ Ready for Implementation (v1.3 contract tightening 2026-04-24) |
| 054     | Public Leaderboards & Read-Only Web Access | Server / Read-Only | Visibility-filtered queries, global rank, fail-closed display names | ⬜ Ready for Implementation (v1.2 contract tightening 2026-04-24) |
