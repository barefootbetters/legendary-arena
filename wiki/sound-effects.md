...
| `bystanderRevealed` | A Bystander is revealed from the villain deck and captured — by the City villain closest to the Villain Deck, or the Mastermind when the City is empty (WP-602) | Short "someone's in danger" civilian sting — the beat that sets up a rescue | Kenney Interface Sounds; OpenGameArt CC0 |
